...
const char* buildInfoGetBuildDate() {
  ...
  static const char BUILD_DATE[] = "2026-07-27 11:07:54.255202";
  return BUILD_DATE;
}

const char* buildInfoGetBuildDir() {

  static const char BUILD_DIR[] = "/home/fernando/FPCE/CLEMNew/PeleC/Exec/RegTests/CLEM1DMach";
  return BUILD_DIR;
}

const char* buildInfoGetBuildMachine() {

  static const char BUILD_MACHINE[] = "Linux Fernnado 6.18.33.2-microsoft-standard-WSL2 #1 SMP PREEMPT_DYNAMIC Thu Jun 18 21:54:43 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux";
  return BUILD_MACHINE;
}

const char* buildInfoGetAMReXDir() {

  static const char AMREX_DIR[] = "/home/fernando/FPCE/CLEMNew/PeleC/Submodules/PelePhysics/Submodules/amrex";
  return AMREX_DIR;
}
...
const char* buildInfoGetGitHash(int i) {
  ...
  static const char HASH1[] = "v1.0.0-10-g11fcefa-dirty";
  static const char HASH2[] = "26.05-2-gff472118";
  static const char HASH3[] = "v1.0.0-20-g9a21bed-dirty";
